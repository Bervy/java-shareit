...
class ItemRequestUnitTests {
    ...
    private static final Pageable PAGE = PageRequest.of(FROM, SIZE, Sort.by(Sort.Direction.DESC, "created"));
    ...
    void findAllByAnotherUser_shouldCallRepository() {
        ...
        when(itemRequestRepository.findAllByRequestorIsNot(user2, PAGE))
        ...
        verify(itemRequestRepository, times(1))
                .findAllByRequestorIsNot(user2, PAGE);
    }
