...
public class ItemControllerImpl implements ItemCrudController<ItemFullDto> {
    ...
    @Override
    @GetMapping
    public List<ItemFullDto> findAll(@RequestHeader("X-Sharer-User-Id") @Min(0) long userId,
    ...
    @Override
    @GetMapping("/{itemId}")
    public Optional<ItemFullDto> findById(@PathVariable("itemId") @Min(0) long itemId,
    ...
    @Override
    @PostMapping
    public Optional<ItemFullDto> save(@RequestHeader("X-Sharer-User-Id") @Min(0) long userId,
                                      @RequestBody @Valid ItemFullDto itemDto) {
        return itemService.save(userId, itemDto);
    }

    @Override
    @PatchMapping("/{itemId}")
    public Optional<ItemFullDto> update(@RequestHeader("X-Sharer-User-Id") @Min(0) long userId,
